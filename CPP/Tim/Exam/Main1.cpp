...
/*
 * I made some small changes to the test files
 *
 ...
 *
 * RE:Ex.4 Since you cannot change the pointer (you get a copy of it, since the pointer is passed by reference) I choose
 * to overwrite the data behind the pointer.
 * */
